...
Dynamoose.prototype.ddb = function () {
  ...
  if(this.endpointURL) {
    ...
    this.dynamoDB = new this.AWS.DynamoDB(this._dynamoOpts);
  }
  return this.dynamoDB;
};
...
Dynamoose.prototype.setDynamoOpts = function(opts) {
  this._dynamoOpts = opts;
};

Dynamoose.prototype.Schema = Schema;
Dynamoose.prototype.Table = require('./Table');
Dynamoose.prototype.Dynamoose = Dynamoose;
Dynamoose.prototype.UpdateOptions = UpdateOptions;
